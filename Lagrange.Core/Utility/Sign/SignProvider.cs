...
public abstract class SignProvider
{
    ...
    protected static bool IsWhiteListCommand(string cmd) =>
        WhiteListCommand.Contains(cmd) ||
        cmd.StartsWith("AvatarInfoSvr.", StringComparison.Ordinal) ||
        cmd.StartsWith("CertifiedAccountSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("ConfigPushSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("ConnAuthSvr.", StringComparison.Ordinal) ||
        cmd.StartsWith("FeedCloudSvr.", StringComparison.Ordinal) ||
        cmd.StartsWith("IncreaseURLSvr.", StringComparison.Ordinal) ||
        cmd.StartsWith("LightAppSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("MQUpdateSvc_", StringComparison.Ordinal) ||
        cmd.StartsWith("MessageSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("MsgProxy.", StringComparison.Ordinal) ||
        cmd.StartsWith("OidbSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("OidbSvcTcp.", StringComparison.Ordinal) ||
        cmd.StartsWith("OidbSvcTrpcTcp.", StringComparison.Ordinal) ||
        cmd.StartsWith("OidbSvcTRPCTcp.", StringComparison.Ordinal) ||
        cmd.StartsWith("OidbSvc_device.", StringComparison.Ordinal) ||
        cmd.StartsWith("PbMessageSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("ProfileService.", StringComparison.Ordinal) ||
        cmd.StartsWith("QQConnectLogin.", StringComparison.Ordinal) ||
        cmd.StartsWith("QQStranger.", StringComparison.Ordinal) ||
        cmd.StartsWith("RegPrxySvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("ResourceConfig.", StringComparison.Ordinal) ||
        cmd.StartsWith("SQQzoneSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("StatSvc.", StringComparison.Ordinal) ||
        cmd.StartsWith("trpc.", StringComparison.Ordinal) ||
        cmd.StartsWith("account.", StringComparison.Ordinal) ||
        cmd.StartsWith("friendlist.", StringComparison.Ordinal) ||
        cmd.StartsWith("gcbindgroupsso.", StringComparison.Ordinal) ||
        cmd.StartsWith("group_member_", StringComparison.Ordinal) ||
        cmd.StartsWith("miniapp.", StringComparison.Ordinal) ||
        cmd.StartsWith("oidb_", StringComparison.Ordinal) ||
        cmd.StartsWith("qidianservice.", StringComparison.Ordinal) ||
        cmd.StartsWith("qzoneh5.", StringComparison.Ordinal) ||
        cmd.StartsWith("wtlogin", StringComparison.Ordinal);
